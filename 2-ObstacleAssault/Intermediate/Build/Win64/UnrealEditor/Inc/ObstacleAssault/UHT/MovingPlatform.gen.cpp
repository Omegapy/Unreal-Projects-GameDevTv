...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MaxDistanceTraveled_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_MaxDistanceTraveled;
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_PlatformVelocity_MetaData[] = {
		{ "Category", "Moving" },
		{ "Comment", "// UPROPERTY(EditAnywhere) Ureal property shows varable in the unreal editor\n// FVector unreal vector, convention F means it is a struc and Vector is a vector, Note A means it is an actor\n// Note Category=\"Moving Platforme\" creates a tab menu in the unreal editor MovingPlatform mesh detail \n" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
		{ "ToolTip", "UPROPERTY(EditAnywhere) Ureal property shows varable in the unreal editor\nFVector unreal vector, convention F means it is a struc and Vector is a vector, Note A means it is an actor\nNote Category=\"Moving Platforme\" creates a tab menu in the unreal editor MovingPlatform mesh detail" },
	};
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxDistanceTraveled_MetaData[] = {
		{ "Category", "Moving" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxDistanceTraveled = { "MaxDistanceTraveled", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AMovingPlatform, MaxDistanceTraveled), METADATA_PARAMS(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxDistanceTraveled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxDistanceTraveled_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MaxDistanceTraveled,
	...
	struct Z_CompiledInDeferFile_FID_Users_User_Documents_Unreal_Projects_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Documents_Unreal_Projects_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 4090158040U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Documents_Unreal_Projects_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_709618186(TEXT("/Script/ObstacleAssault"),
		Z_CompiledInDeferFile_FID_Users_User_Documents_Unreal_Projects_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Documents_Unreal_Projects_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
